...
secret = 'dfhja,sudjf.i$#@$#dsafd42gf4g-ewf-few0f'
...
class Handler(webapp2.RequestHandler):
    ...
    def initialize(self, *a, **kw):
        ...
        self.can_post = self.user and self.user.name == 'virco'
    ...
    def notfound(self):
        self.error(404)
        self.write('<h1>404: Not Found</h1>Sorry, my friend, that page does not exist.')
